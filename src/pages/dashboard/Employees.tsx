...
import { ArrowLeft, CalendarIcon, Loader2, Save, UserPlus, User } from "lucide-react";
    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-10">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Fill in employee details to create a new record</p>
        </div>
      </div>
